...
var checksumMap = map[string]string{
	"./release/devpod-provider-multipass-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-multipass-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-multipass-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-multipass-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-multipass-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
